...
func init() {
	...
	ptbrDict["  syncedpz play = syncs all servers at the start and at the end. And starts Project Zomboid"] = "  syncedpz play = sincroniza um servidor no início e no final. E inicia o Project Zomboid"
	...
	ptbrDict["  [9] Set language"] = "  [9] Definir idioma"
	ptbrDict["  [10] Exit"] = "  [10] Sair"
	...
	ptbrDict["Enter the path to the pz executable: "] = "Digite o caminho para o executável do pz: "
	...
	ptbrDict["PZ Exe Path: "] = "Caminho do executável do PZ: "
